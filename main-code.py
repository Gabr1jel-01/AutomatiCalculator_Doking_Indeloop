...
# region List
lista_rijecnika_plinova = [o2, n2, ch4, h2, h2o, c2h2,
                           c2h4, c2h5oh, c2h6, co, c2h8, c6h6, co2, h2s, so2]
# endregion
...
def izracunaj():
    ...
    if unos_plina_1 == "":
        ...
        if unesena_temperatura in gas_dict:
            textbox_racunica_1.insert(
                1.0, text=f"{gas_dict[unesena_temperatura]}")
        else:
            for key in sorted(gas_dict.keys()):
                if key <= unesena_temperatura:
                    ...
                    break
            a = float(value_lower) + (float(value_higher)-float(value_lower)) / \
                (float(next_higher)-float(next_lower)) * \
                (unesena_temperatura-float(next_lower))
        ...
        if unesena_temperatura in gas_dict:
            ...
            for key in sorted(gas_dict.keys()):
                if key <= unesena_temperatura:
                    ...
                    value_higher = gas_dict[next_higher]
                    break
            b = float(value_lower) + (float(value_higher)-float(value_lower)) / \
                (float(next_higher)-float(next_lower)) * \
                (unesena_temperatura-float(next_lower))
        ...
        if unesena_temperatura in gas_dict:
            ...
            for key in sorted(gas_dict.keys()):
                if key <= unesena_temperatura:
                    ...
                    value_higher = gas_dict[next_higher]
                    break
            c = float(value_lower) + (float(value_higher)-float(value_lower)) / \
                (float(next_higher)-float(next_lower)) * \
                (unesena_temperatura-float(next_lower))
        ...
        if unesena_temperatura in gas_dict:
            ...
            for key in sorted(gas_dict.keys()):
                if key <= unesena_temperatura:
                    ...
                    value_higher = gas_dict[next_higher]
                    break
            d = float(value_lower) + (float(value_higher)-float(value_lower)) / \
                (float(next_higher)-float(next_lower)) * \
                (unesena_temperatura-float(next_lower))
        ...
        if unesena_temperatura in gas_dict:
            ...
            for key in sorted(gas_dict.keys()):
                if key <= unesena_temperatura:
                    ...
                    value_higher = gas_dict[next_higher]
                    break
            e = float(value_lower) + (float(value_higher)-float(value_lower)) / \
                (float(next_higher)-float(next_lower)) * \
                (unesena_temperatura-float(next_lower))
        ...
        if unesena_temperatura in gas_dict:
            ...
            for key in sorted(gas_dict.keys()):
                if key <= unesena_temperatura:
                    ...
                    value_higher = gas_dict[next_higher]
                    break
            f = float(value_lower) + (float(value_higher)-float(value_lower)) / \
                (float(next_higher)-float(next_lower)) * \
                (unesena_temperatura-float(next_lower))
...
def kopiraj_sve_izracune():
    ...
    long_string_of_copy = f"{first_copy}{second_copy}{
        third_copy}{fourth_copy}{fifth_copy}{sixth_copy}"
...
plin_entry_1 = ctk.CTkEntry(aplikacija, placeholder_text="Unesite plin",
                            width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

plin_entry_1.place(x=20, y=200)

plin_entry_2 = ctk.CTkEntry(aplikacija, placeholder_text="Unesite plin",
                            width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

plin_entry_2.place(x=20, y=250)

plin_entry_3 = ctk.CTkEntry(aplikacija, placeholder_text="Unesite plin",
                            width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

plin_entry_3.place(x=20, y=300)

plin_entry_4 = ctk.CTkEntry(aplikacija, placeholder_text="Unesite plin",
                            width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

plin_entry_4.place(x=20, y=350)

plin_entry_5 = ctk.CTkEntry(aplikacija, placeholder_text="Unesite plin",
                            width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

plin_entry_5.place(x=20, y=400)

plin_entry_6 = ctk.CTkEntry(aplikacija, placeholder_text="Unesite plin",
                            width=200, height=40, corner_radius=0, font=("Times New Roman", 18))
...
entry_temperatura = ctk.CTkEntry(aplikacija, width=300, height=30,
                                 placeholder_text="Unesite temperaturu bez mjerne jedinice", font=("Times New Roman", 18))
...
textbox_racunica_1 = ctk.CTkTextbox(
    aplikacija, width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

textbox_racunica_1.place(x=670, y=200)

textbox_racunica_2 = ctk.CTkTextbox(
    aplikacija, width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

textbox_racunica_2.place(x=670, y=250)

textbox_racunica_3 = ctk.CTkTextbox(
    aplikacija, width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

textbox_racunica_3.place(x=670, y=300)

textbox_racunica_4 = ctk.CTkTextbox(
    aplikacija, width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

textbox_racunica_4.place(x=670, y=350)

textbox_racunica_5 = ctk.CTkTextbox(
    aplikacija, width=200, height=40, corner_radius=0, font=("Times New Roman", 18))

textbox_racunica_5.place(x=670, y=400)

textbox_racunica_6 = ctk.CTkTextbox(
    aplikacija, width=200, height=40, corner_radius=0, font=("Times New Roman", 18))
...
# this label is used to display gases measure unit
label_mjerna_jedinica_6 = ctk.CTkLabel(
    aplikacija, text="KJ/KmolK", font=("Times New Roman", 24))
...
button_izracunaj = ctk.CTkButton(aplikacija, width=100, height=50, text="Izračunaj",
                                 command=izracunaj, corner_radius=0, fg_color="#979797", hover_color="#5D5959")
button_izracunaj.place(x=420, y=680)


button_del_all = ctk.CTkButton(aplikacija, width=50, height=40, text="DEL ALL", font=(
    "Times New Roman", 20), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_sve_unesene_plinove)
button_del_all.place(x=20, y=100)


button_delete_plin_1 = ctk.CTkButton(aplikacija, width=30, height=40, text="DEL", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_unos_plina_1)
button_delete_plin_1.place(x=220, y=200)


button_delete_plin_2 = ctk.CTkButton(aplikacija, width=30, height=40, text="DEL", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_unos_plina_2)
button_delete_plin_2.place(x=220, y=250)


button_delete_plin_3 = ctk.CTkButton(aplikacija, width=30, height=40, text="DEL", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_unos_plina_3)
button_delete_plin_3.place(x=220, y=300)


button_delete_plin_4 = ctk.CTkButton(aplikacija, width=30, height=40, text="DEL", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_unos_plina_4)
button_delete_plin_4.place(x=220, y=350)


button_delete_plin_5 = ctk.CTkButton(aplikacija, width=30, height=40, text="DEL", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_unos_plina_5)
button_delete_plin_5.place(x=220, y=400)


button_delete_plin_6 = ctk.CTkButton(aplikacija, width=30, height=40, text="DEL", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#EB4242", hover_color="#A76A6A", command=izbrisi_unos_plina_6)
button_delete_plin_6.place(x=220, y=450)


button_copy_data = ctk.CTkButton(aplikacija, width=30, height=40, text="Copy All", font=(
    "Times New Roman", 24), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_sve_izracune)
button_copy_data.place(x=880, y=100)


button_copy_izracun_1 = ctk.CTkButton(aplikacija, width=30, height=40, text="COPY", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_izracune_plin_1)
button_copy_izracun_1.place(x=630, y=200)


button_copy_izracun_2 = ctk.CTkButton(aplikacija, width=30, height=40, text="COPY", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_izracune_plin_2)
button_copy_izracun_2.place(x=630, y=250)


button_copy_izracun_3 = ctk.CTkButton(aplikacija, width=30, height=40, text="COPY", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_izracune_plin_3)
button_copy_izracun_3.place(x=630, y=300)


button_copy_izracun_4 = ctk.CTkButton(aplikacija, width=30, height=40, text="COPY", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_izracune_plin_4)
button_copy_izracun_4.place(x=630, y=350)


button_copy_izracun_5 = ctk.CTkButton(aplikacija, width=30, height=40, text="COPY", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_izracune_plin_5)
button_copy_izracun_5.place(x=630, y=400)


button_copy_izracun_6 = ctk.CTkButton(aplikacija, width=30, height=40, text="COPY", font=(
    "Times New Roman", 14), corner_radius=0, fg_color="#218ED1", hover_color="#196DA0", command=kopiraj_izracune_plin_6)
